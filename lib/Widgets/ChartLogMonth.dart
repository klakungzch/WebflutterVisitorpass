...
class ChartLogMonthWidget extends StatelessWidget {
  String nameMonthYear;
  List<int> numDayscheckin;
  ChartLogMonthWidget(String nameMonthYear, List<int> numDayscheckin){
  ...
  Widget build(BuildContext context) {
    ...
    final List<LogMonthChart> dataChartcheckin = [
      for(int i=0;i<31;i++)
        new LogMonthChart(i+1, this.numDayscheckin[i]),
    ];
    ...
    List<charts.Series<LogMonthChart, int>> series = [
      charts.Series(
        ...
        colorFn: (LogMonthChart sales, _) => charts.ColorUtil.fromDartColor(Color(0xff00ff80)),
