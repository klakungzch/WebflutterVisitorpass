    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
          ...
          con_name.text = snapshot.data['con_name'];
          con_promptpay.text = snapshot.data['con_promptpay'];
          con_hour.text = snapshot.data['con_hour'].toString();
          con_rate.text = snapshot.data['con_rate'].toString();
            ...
            child: Center(
              child: Container(
                ...
                child :Column(
                  ...
                  children: [
                    topUserEdit(context, '${word.editCondoHeader['$lang']} : ${snapshot.data['con_name']}'),
                    SizedBox(height: 15),
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Text('${word.dialogEditCondoDetail1_1['$lang']} ${snapshot.data['con_name']}${word.dialogEditCondoDetail1_2['$lang']}', style: TextStyle(color: Colors.white, fontFamily: 'Prompt'), textAlign: TextAlign.center),
                                      ),
                                      Row(
