                    ...
                    children: [
                      Column(
                        ...
                        children: snapshot.data.docs.map((DocumentSnapshot document) {
                          ...
                          else if(document['firstName'].toString().contains(textToSearch)){
                            checkNotfoundData = false;
                            return listUserGuard(document);                
                          }
                          else{
      ...
      child: new Card(
        ...
        child: ListTile(
          ...
          title: Wrap(
            spacing: 5,
            children: [
              new Text('${word.fullname['$lang']} : ${document['firstName']} ${document['lastName']}' ,style: (TextStyle(fontFamily: 'Prompt'))),
              if(document['status'] == true) Icon(Icons.check_circle, color: Colors.green,)
          ...
          subtitle: new Column(
            ...
            children: [
              Text('${word.username['$lang']} : ${document['username']}',style: (TextStyle(fontFamily: 'Prompt'))),
              Text('${word.condoName['$lang']} : ${document['condo_name']}',style: (TextStyle(fontFamily: 'Prompt'))),
            ],
          ),
          trailing: Wrap(
            spacing: 12,
            children: [
              IconButton(
                ...
                tooltip: '${word.editprofile['$lang']} : ${document['firstName']}',
                onPressed: (){
                  Navigator.push(context,  MaterialPageRoute(builder: (context) => EditUserGuard(document.id, document['condo_name'],  this.lang)));
                },
              ),
              IconButton(
                icon: Icon(Icons.delete),
                tooltip: '${word.delete['$lang']} : ${document['firstName']}',
                onPressed: (){
                  showDialog( 
                    context: context, 
                    builder: (context) {
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text('${word.dialogAdminDetail1_1['$lang']} ${document['firstName']}${word.dialogAdminDetail1_2['$lang']}', style: TextStyle(color: Colors.white, fontFamily: 'Prompt'), textAlign: TextAlign.center,),
                              ),
                              Row(
