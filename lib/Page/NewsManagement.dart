...
class _NewsManagementState extends State<NewsManagement> {
  ...
  Query condo = FirebaseFirestore.instance.collection('News');
                      ...
                      children: [
                        Column(
                          ...
                          children: snapshot.data.docs.map((DocumentSnapshot document) {
                            ...
                            else if(document.data()['title'].toString().toLowerCase().contains(textToSearch.toLowerCase())){
                              checkNotfoundData = false;
                              return listProfileCondo(document);
                            }
                            else{
      ...
      child: new Card(
        ...
        child: ListTile(
          ...
          title: Wrap(
            spacing: 5,
            children: [
              new Text('${word.newsName['$lang']} : ${document.data()['title']}' ,style: (TextStyle(fontFamily: 'Prompt'))),
            ],
          ),
          subtitle: new Column(
            ...
            children: [
              Text(
                  '${word.newsDate['$lang']} : ${document.data()['datetime']}',
          ...
          trailing: Wrap(
            ...
            children: [
              IconButton(
                ...
                tooltip: '${word.editCondo['$lang']} : ${document.data()['title']}',
                onPressed: (){
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text('${word.dialogNewsDetail1_1['$lang']} ${document.data()['title']}${word.dialogNewsDetail1_2['$lang']}', style: TextStyle(color: Colors.white, fontFamily: 'Prompt'), textAlign: TextAlign.center,),
                              ),
                              Row(
