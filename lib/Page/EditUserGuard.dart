    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
          ...
          firstName.text = snapshot.data.data()['firstName'];
          lastName.text = snapshot.data.data()['lastName'];
          username.text = snapshot.data.data()['username'];
          confirmpass.text = snapshot.data.data()['pin'];
          password.text = snapshot.data.data()['pin'];
                  ...
                  children: [
                    if(screenWidth>1000)
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          topUserEdit(context, '${word.edituserHeader['$lang']} : ${snapshot.data.data()['firstName']}'),
                          topStatus(context)
                        ]
                      )
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Text('${word.dialogEdituserDetail1_1['$lang']} ${snapshot.data.data()['firstName']}${word.dialogEdituserDetail1_2['$lang']}', style: TextStyle(color: Colors.white, fontFamily: 'Prompt'), textAlign: TextAlign.center),
                                      ),
                                      Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          ElevatedButton(onPressed: (){
                                              ...
                                              else status = snapshot.data.data()['status'];
