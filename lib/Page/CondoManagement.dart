          ...
          trailing: Wrap(
            ...
            children: [
              IconButton(
                ...
                tooltip: '${word.editCondo['$lang']} : ${document['con_name']}',
                onPressed: (){
              ...
              IconButton(
                ...
                tooltip: '${word.deleteCondo['$lang']} : ${document['con_name']}',
                onPressed: (){
                  showDialog(
                    context: context,
                    builder: (context) {
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                ...
                                child: Text('${word.dialogCondoDetail1_1['$lang']} ${document['con_name']}${word.dialogCondoDetail1_2['$lang']}', style: TextStyle(color: Colors.white, fontFamily: 'Prompt'), textAlign: TextAlign.center,),
                              ),
                              Row(
