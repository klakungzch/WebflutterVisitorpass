    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot> snapshot) {
          ...
          news_detail.text = snapshot.data.data()['detail'];
            ...
            child: Center(
              child: Container(
                ...
                child :Column(
                  ...
                  children: [
                    topUserEdit(context, '${word.editNewsHeader['$lang']} : ${snapshot.data.data()['title']}'),
                    SizedBox(height: 15),
                                  ...
                                  child: Column(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Padding(
                                        ...
                                        child: Text('${word.dialogEditNewsDetail1_1['$lang']} ${snapshot.data.data()['title']}${word.dialogEditNewsDetail1_2['$lang']}', style: TextStyle(color: Colors.white, fontFamily: 'Prompt'), textAlign: TextAlign.center),
                                      ),
                                      Row(
